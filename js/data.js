...
const MASSAGES = [
  ...
  'В этих глазах целый мир...',
  'Ты выглядишь просто потрясающе на этом фото.',
  'Впечатляющее фото.',
  'Как тебе удается каждый раз выглядеть так шикарно?',
  'Перед такой красотой сложно устоять.',
  'Милота зашкаливает.',
  'Твой взгляд завораживает.',
  'Уникальных комментариев',
  'Девочка, ты просто безупречна!',
  'Просто икона, я влюбился!',
  'Обожаю эту фотографию.',
  'Мне нравится этот стиль на тебе.',
  'Ты просто меня ошарашила.',
  'Огонь!',
  'Принцесса!',
  'Ты всегда идеальна, в любом платье.',
  'Самая симпатичная.',
  'Великолепно!',
];
...
function getComment(commentID) {
  ...
  const randomAvatar = getRandomInteger(1, AVATARS);
  return {
    id: commentID,
